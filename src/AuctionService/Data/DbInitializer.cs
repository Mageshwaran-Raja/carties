...
namespace AuctionService.Data
{
    ...
    {
        public static void InitializeDb(WebApplication application)
        {
            using var scope = application.Services.CreateScope();

            SeedData(scope.ServiceProvider.GetService<AutionDbContext>());
        }

        private static void SeedData(AutionDbContext context)
        {
            ...
            new Auction
            {
                ...
                ReservedPrice = 20000,
                Seller = "bob",
                AutionEnd = DateTime.UtcNow.AddDays(10),
                Item = new Item
                {
                    Make = "Ford",
                    Model = "GT",
            ...
            new Auction
            {
                ...
                ReservedPrice = 90000,
                Seller = "alice",
                AutionEnd = DateTime.UtcNow.AddDays(60),
                Item = new Item
                {
                    Make = "Bugatti",
                    Model = "Veyron",
            ...
            new Auction
            {
                ...
                Status = Status.Live,
                Seller = "bob",
                AutionEnd = DateTime.UtcNow.AddDays(4),
                Item = new Item
                {
                    Make = "Ford",
                    Model = "Mustang",
            ...
            new Auction
            {
                ...
                ReservedPrice = 20000,
                Seller = "alice",
                AutionEnd = DateTime.UtcNow.AddDays(30),
                Item = new Item
                {
                    Make = "BMW",
                    Model = "X1",
            ...
            new Auction
            {
                ...
                ReservedPrice = 20000,
                Seller = "bob",
                AutionEnd = DateTime.UtcNow.AddDays(45),
                Item = new Item
                {
                    Make = "Ferrari",
                    Model = "Spider",
            ...
            new Auction
            {
                ...
                Seller = "alice",
                AutionEnd = DateTime.UtcNow.AddDays(13),
                Item = new Item
                {
                    Make = "Ferrari",
                    Model = "F-430",
            ...
            new Auction
            {
                ...
                Status = Status.Live,
                Seller = "bob",
                AutionEnd = DateTime.UtcNow.AddDays(19),
                Item = new Item
                {
                    Make = "Audi",
                    Model = "R8",
            ...
            new Auction
            {
                ...
                ReservedPrice = 20000,
                Seller = "tom",
                AutionEnd = DateTime.UtcNow.AddDays(20),
                Item = new Item
                {
                    Make = "Audi",
                    Model = "TT",
            ...
            new Auction
            {
                ...
                ReservedPrice = 20000,
                Seller = "bob",
                AutionEnd = DateTime.UtcNow.AddDays(48),
                Item = new Item
                {
                    Make = "Ford",
                    Model = "Model T",
